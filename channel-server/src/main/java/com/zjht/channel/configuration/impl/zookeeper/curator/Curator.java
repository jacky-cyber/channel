...
import static com.zjht.channel.common.constant.RespCode._00301;
import static com.zjht.channel.common.constant.RespCode._00302;
...
import com.zjht.channel.exception.ZookeeperException;
...
public class Curator implements ZKClient {
    ...
    public void create(String path, String data) {
        ...
        if (exists(path)) {
            ExceptionHelper.newZookeeperException(_00302, zkNamespace, path).throwout();
        }
...
//            .withACL(ZooDefs.Ids.OPEN_ACL_UNSAFE)//访问权限
    ...
    public void delete(String path) {
        if (!exists(path)) {
            ExceptionHelper.newZookeeperException(_00301, zkNamespace, path).throwout();
        }
        try{
