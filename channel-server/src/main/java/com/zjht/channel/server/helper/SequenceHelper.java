/**
 * Project Name:channel-server File Name:SequenceHelper.java Package
 * Name:com.zjht.channel.server.helper Date:2015年9月2日下午4:42:07
 * 
 */
...
public class SequenceHelper {
     ...
     * <b>注意:</b> <br/>
     * <p>
     * 该序列最大支持1毫秒内产生99999(TAIL_LENGTH长度)个序列的并发,超过这个数则可能产生重复的序列
     * </p>
     * 
     * @author jun yangwenjun@chinaexpresscard.com
     * @return
    ...
    public static String next() {
        ...
        for (;;) {
            ...
            long nextLong = String.valueOf(currLong + 1).length() > TAIL_LENGTH ? TAIL_MIN_VALUE
                    : (currLong + 1);
        ...
        str = WORKERID.concat(Symbol.HYPHEN.code()).concat(PREFIX)
                .concat(DATE_FORMAT.format(new Date())).concat(tail);
        return str;
    }
