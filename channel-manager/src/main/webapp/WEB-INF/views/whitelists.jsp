...
<title>渠道管理系统-白名单</title>
<link href="resources/css/dataTables.bootstrap.css" rel="stylesheet">
<link href="resources/css/whitelists.css" rel="stylesheet">

<script src="resources/js/jquery.dataTables.js"></script>
<script src="resources/js/dataTables.bootstrap.js"></script>
<script src="resources/js/whitelists.js"></script>
</head>
<body>
	            ...
	            <div class="modal-body">
	                <form id="whitelists_form">
					  <div class="form-group">
					    ...
					    <input type="text" class="form-control" id="ipAddress"  autocomplete="off" placeholder="请输入IP地址" >
					  </div>
					  <div class="form-group">
					    <label for="hostname">主机名称</label>
					    <input type="text" class="form-control" id="hostname"  autocomplete="off" placeholder="请输入主机名称" >
					  </div>					  
					  <div class="form-group">
