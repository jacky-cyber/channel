...
$(document).ready(function() {
	...
	$('#dataTable').on( 'error.dt', function ( e, settings, techNote, message ) {
		...
		"columns": [
		            ...
		            { "data": "key","defaultContent": "","visible": true },
...
/*	var _hostname = $.trim($("#hostname").val());
	...
	return !isEmpty(_appno,"请输入终端号")&&!isEmpty(_key,"请输入秘钥");
}
...
function toAdd(){
    ...
    var _remark = $.trim($("#remark").val());
	var params    = '{"appno":"'+_appno+'","key":"'+_key+'","name":"'+_name+'","remark":"'+_remark+'"}';
	var url       = "security";
	$.ajax({
	    type: "POST",
	    dataType: "json",
